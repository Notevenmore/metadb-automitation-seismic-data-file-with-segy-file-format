...
export const datatypes = {
  ...
  '2D Seismic Field Data Stored In Media':
    '2d_seismic_field_data_stored_in_media',
  '2D Seismic Process Data Stored In Media':
    '2d_seismic_process_data_stored_in_media',
  ...
  '2D Seismic Navigation Data Stored In Media':
    '2d_seismic_navigation_data_stored_in_media',
  '3D Seismic Summary': '3d_seismic_summary',
  '3D Seismic Field Data Stored In Media':
    '3d_seismic_field_data_stored_in_media',
  '3D Seismic Process Data Stored In Media':
    '3d_seismic_process_data_stored_in_media',
  ...
  '3D Seismic Navigation Data Stored In Media':
    '3d_seismic_navigation_data_stored_in_media',
  ...
  'Non-Seismic And Seismic Unconventional Survey Summary':
    'non-seismic_and_seismic_unconventional_survey_summary',
  'Non-Seismic And Seismic Unconventional Data Stored In Media':
    'non-seismic_and_seismic_unconventional_data_stored_in_media',
  'Non-Seismic And Seismic Unconventional Digital Data':
    'non-seismic_and_seismic_unconventional_digital_data',
  'Non-Seismic And Seismic Unconventional Printed Report':
    'non-seismic_and_seismic_unconventional_printed_report',
  'Non-Seismic And Seismic Unconventional Digital Report':
    'non-seismic_and_seismic_unconventional_digital_report',
  ...
  'Well Seismic Profile Stored In Media':
    'well_seismic_profile_stored_in_media',
