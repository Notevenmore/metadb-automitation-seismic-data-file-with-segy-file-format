...
const Popup = () => {
  ...
  return (
    <div className="fixed top-0 left-0 flex items-center justify-center w-screen h-screen bg-black/[.2]">
      <div className="h-auto min-h-[170px] w-[500px] bg-white border-gray-300 border-2 rounded-md px-6 py-5">
