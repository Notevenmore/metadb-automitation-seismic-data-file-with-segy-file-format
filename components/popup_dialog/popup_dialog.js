...
const PopupDialog = ({
  ...
  content,
  button_desc1 = 'Save',
  button_desc2 = 'Save and exit',
  button_desc3 = 'Discard changes',
}) => {
  const DEFAULT_CONTENT = () => {
    return (
      <>
        You have not saved the document yet, are you sure you want to leave this
        page?
        <strong>
          {' '}
          This document will not be uploaded and will be deleted.
        </strong>
      </>
    );
  };
