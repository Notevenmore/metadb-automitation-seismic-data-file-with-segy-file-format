...
const FloatDialog = ({ children, float_title, items = null, onClick = null, width = "340px", className }) => {
...
const NotificationIcon = () => {
	return <img src="/icons/bell-outline.svg" alt="notif" className="w-[19px] h-[24px]"></img>;
};

const ProfileIcon = () => {
	return <img src="/images/unknown.jpg" alt="profile" className="w-[26px] rounded-full"></img>;
};
...
const Divider = ({ additional_styles = null }) => {
	return <hr className={twMerge(`border-1 border-solid border-float_section_divider`, additional_styles)}></hr>;
};
