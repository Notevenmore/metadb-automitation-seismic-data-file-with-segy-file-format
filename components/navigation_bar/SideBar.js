...
export default function SideBar({ half }) {
	...
	return (
		<div
			...
			className={`float-left justify-between full-height ${iconCollapse ? "w-[57px]" : "w-[314px]"} flex flex-col bg-side_bar overflow-y-auto overflow-x-hidden relative transition-all`}
		...
		>
			...
			<div className={`min-h-[35px] ${iconCollapse ? "hidden" : "w-[314px]"} flex items-center justify-center text-[12px] text-[#a3a3a3] bg-side_bar`}>
