...
const Action = () => {
    return (
        <div className="flex flex-row gap-x-1 items-center">
            ...
            <Link href="/basin/edit"><Image src="/icons/pencil.svg" width={50} height={50} className="w-[25px] h-[15px] alt='' " alt="icon" /></Link>
...
export default {
    ...
    content:[
        {no: 1, name: "Laporan 2023", KKS: "GTN", "wilayah kerja": "Jakarta", jenis: "Not set", AFE: "Not set", action: <Action />},
    ]
}