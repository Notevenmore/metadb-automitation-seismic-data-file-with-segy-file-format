...
1. Login with admin credentials
    ...
    ![Untitled](/markdown-src/Untitled.png)
    
2. The admin is able to  create new users as well as new admins from the following:
    
    ![Untitled](/markdown-src/Untitled%201.png)
    
    ![Untitled](/markdown-src/Untitled%202.png)
    
3. The admin is able to observe and update existing users as well:
    
    ![Untitled](/markdown-src/Untitled%203.png)
...
1. Admin can change user details with the eye icon, or delete the account with trash icon
    ...
    ![Untitled](/markdown-src/Untitled%204.png)
...
1. Login using credentials with username and password
    ...
    ![SCR-20230628-sfem.png](/markdown-src/SCR-20230628-sfem.png)
    
    ![SCR-20230628-sfgp.png](/markdown-src/SCR-20230628-sfgp.png)
    
2. User can pick if they want to make a new record or choose a file manually
    
    ![SCR-20230628-sfkt.png](/markdown-src/SCR-20230628-sfkt.png)
...
![SCR-20230628-sfrs.png](/markdown-src/SCR-20230628-sfrs.png)

Available file formats:

## Methods of data matching

![Untitled](/markdown-src/Untitled%205.png)
...
![SCR-20230628-sfom.png](/markdown-src/SCR-20230628-sfom.png)
...
![Untitled](/markdown-src/Untitled%206.png)
...
![Untitled](/markdown-src/Untitled%207.png)
