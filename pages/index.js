        ...
        <div className='flex flex-col flex-grow overflow-auto'>
          <div className='flex flex-col space-y-2 py-5 px-10'>
            ...
            <div className='flex flex-col space-y-2'>
              <Buttons path={'/button'} button_description='Buttons documentation'><Well_sample_core /></Buttons>
              <Buttons path={'/table'} button_description='Table documentation'><Well_sample_core /></Buttons>
              <Buttons path={'/input'} button_description='Input form documentation'><Well_sample_core /></Buttons>
            </div>
          </div>
        </div>
      </div>
