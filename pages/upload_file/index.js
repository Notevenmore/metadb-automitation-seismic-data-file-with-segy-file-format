				...
				<div className="w-[80%] max-w-[80%] flex items-center justify-center">
					<div className="flex space-x-3 overflow-auto">
						...
						<Buttons id="highlight" title="" additional_styles={`h-full active:bg-gray-400/60 outline-none ${UplSettings.Method === "highlight" ? "bg-searchbg/60" : ""}`} onClick={(e) => { setUplSettings({ ...UplSettings, Method: "highlight" }) }}>
							<div className="flex space-x-2 min-w-max items-center p-2">
								<svg width="45" height="45" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="48" height="48" fill="white" fill-opacity="0.01" /><path d="M12 4H4V12H12V4Z" fill="none" stroke="#333" stroke-width="1" stroke-linejoin="round" /><path d="M44 36H36V44H44V36Z" fill="none" stroke="#333" stroke-width="1" stroke-linejoin="round" /><path d="M12 36H4V44H12V36Z" fill="none" stroke="#333" stroke-width="1" stroke-linejoin="round" /><path d="M44 4H36V12H44V4Z" fill="none" stroke="#333" stroke-width="1" stroke-linejoin="round" /><path d="M8 36V12" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1 5" /><path d="M40 36V12" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1 5" /><path d="M12 8H36" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1 5" /><path d="M12 40H36" stroke="#333" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" stroke-dasharray="1 5" /></svg>
								<section className="w-[150px]">
									<h3 className="text-lg font-bold">Highlighting</h3>
									<p className="text-sm">Choose the correct data matches by highlighting the document preview.</p>
								</section>
							</div>
						</Buttons>
						<Buttons id="dragdrop" title="" additional_styles={`h-full active:bg-gray-400/60 outline-none ${UplSettings.Method === "dragdrop" ? "bg-searchbg/60" : ""}`} onClick={(e) => { setUplSettings({ ...UplSettings, Method: "dragdrop" }) }}>
							<div className="flex space-x-2 min-w-max items-center p-2">
								...
								<section className="w-[150px]">
									...
									<p className="text-sm">Choose the correct data matches using drag and drop method. <strong>(Rather slow, please consider).</strong></p>
								</section>
							</div>
						</Buttons>
						<Buttons id="automatic" title="" additional_styles={`h-full active:bg-gray-400/60 outline-none ${UplSettings.Method === "automatic" ? "bg-searchbg/60" : ""}`} onClick={(e) => { setUplSettings({ ...UplSettings, Method: "automatic" }) }} >
							<div className="flex space-x-2 min-w-max items-center p-2">
								...
								<section className="w-[150px]">
									...
									<p className="text-sm">Automatically predict data matches. <br /><strong>(Rather slow, please consider).</strong></p>
								</section>
							</div>
						</Buttons>
					</div>
