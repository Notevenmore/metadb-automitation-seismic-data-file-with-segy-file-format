    ...
    <Container>
      <div className="flex flex-col space-y-2">
        ...
        <ul className="list-disc px-10">
          <code>
            <li className="pt-1">handleClick: function</li>
          </code>
        </ul>
        <h3 className="text-xl font-bold">Example</h3>
        <p>
          The function is not required by the component, only if the control to
          toggle the side navigation bar is it required.
        </p>
