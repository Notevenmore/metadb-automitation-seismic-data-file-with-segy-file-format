    ...
    <Container>
      <div className="full-height flex flex-col items-center justify-center gap-y-[150px]">
        <div className="flex flex-col items-center gap-y-10">
          <p className="text-[128px] leading-[56px] font-bold">MetaDB</p>
          <p className="text-[24px] leading-[22px] text-[#737b7d] tracking-[.3px]">
            Effectively Cataloging and Managing E&amp;P Physical Assets
          </p>
          <div className="border w-full border-b-[#d9d9d9]"></div>
        </div>
        <div className="text-[24px] leading-[29.5px] flex flex-col items-center text-center justify-center gap-y-5 max-w-[1117px]">
          Please wait while your account is being verified by the admin. You
          will get notification email through email that&apos;s used to make
          this account when your account has been confirmed and activated by the
          admin.
          <Buttons
            path="/login/signin"
            button_description="I understand"
            additional_styles="bg-primary text-[16px]"
          />
        </div>
