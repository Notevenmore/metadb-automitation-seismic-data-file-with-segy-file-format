...
const BoldCode = ({children}) => {
  return(
    <code><strong>{children}</strong></code>
  )
}
...
const HeaderSection = () => {
  return (
    <header className="mb-[2em]">
      ...
      <p className='mb-[10px]'>This is a functional component in React which renders a
       floating dialog box with optional title and contents. The component takes in several props:
      </p>
      <ul className='mb-[10px] list-disc px-10'>
          <li className='pt-1'> <BoldCode>`children`: </BoldCode>
           any React components or elements that will trigger the dialog box to open when clicked.</li>
          <li className='pt-1'><BoldCode>`float_title`: </BoldCode>
           an optional string that will be rendered as the title of the floating dialog box.</li>
          <li className='pt-1'><BoldCode>`items`: </BoldCode>
           an optional array of objects containing the contents of the floating dialog box.
           Each object should have a section_title property and a section_content property, both of which are strings.</li>
          <li className="pt-1"><BoldCode>`onClick`: </BoldCode>
           an optional function that will be called when the dialog box is clicked.
...
const Example1 = () => {
  ...
  return (
    <section>
      <ExampleTitle>Example 1: Notification dialog in the center of the screen</ExampleTitle>
      <CodeSnippet>
        {
...
const Example2 = ({className}) => {
  const items_profile = {
    ...
    contents: [
        {section_title: "hello", section_content: "hello there"},
        {section_title: "a notification", section_content: "lorem ipsum dolor sit amet"},
        {section_title: "another notification", section_content: "hey, we have a new announcement!"},
        {section_title: "An important notification", section_content: "Please read this immediately!"}
    ]     
  }

  return (
    <section className={className}>  
      <ExampleTitle>Example 2: Profile dialog in the top-left of the screen</ExampleTitle>    
...
const Example3 = ({className}) => {
  ...
  return (
    <section className={className}>      
      <ExampleTitle>Example 3: General floating dialog in the bottom-right of the screen</ExampleTitle>
