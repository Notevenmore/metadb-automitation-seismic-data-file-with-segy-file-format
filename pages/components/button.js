      ...
      <div className="w-full flex flex-auto">
        <div className="flex flex-col flex-grow overflow-auto">
          <div className="flex flex-col space-y-2 py-5 px-10">
            ...
            <p>
              The <code>Button</code> component consists of the following
            ...
            <p>
              The <code className="font-bold">additional_styles</code> prop is
              not mandatory to be filled, just like the above example.
            </p>
            <pre>
              <Highlight className="html rounded-md border-2">
                {
            ...
            <Button
              ...
              button_description="View drafts"
              additional_styles={
                'border-[3px] border-green-600 italic bg-green-600 text-white font-bold hover:bg-green-500'
              }
            />
