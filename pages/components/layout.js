    ...
    return (
        <Container>
            <div className="flex flex-col gap-y-3">
                ...
                <p>
                    Inside the file where you want a different layout, you need
                    to call the function you defined outside of the component
                    function.
                </p>
                <Highlight className="html rounded-md border-2">
                    {
                ...
                <p>
                    For the app to recognize a different layout you had set for different pages, you need to set it as such. In the case below, <code>getLayoutBlank</code> is the default layout you are applying for all the pages if there is no <code>Component.getLayout</code> detected in any of the pages.
                </p>
                <Highlight className="html rounded-md border-2">
                    {
                ...
                <p>For reference, go <a href="https://nextjs.org/docs/basic-features/layouts" target="_blank" className="text-link">here</a>.</p>
            </div>
        </Container>
    );
}
