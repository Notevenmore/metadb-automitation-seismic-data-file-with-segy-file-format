	...
	return (
		<Container>
			<div className="flex flex-col gap-y-3">
				...
				<Highlight className="html rounded-md border-2">{"<Container> <div></div> </Container>"}</Highlight>
				...
				<Container.Title>Title</Container.Title>
				<p>
					Adding a <code>back</code> as seen below, the title now will have a back button on the right side of
					the title which can be used to go back to previous page
				</p>
				<p className="font-bold">Code:</p>
				<Highlight className="html rounded-md border-2">
				...
				<p>
					Adding a <code>tab</code> as seen below, will align the subtitle to the title if it contains a back
					button inside
				</p>
				<p className="font-bold">Code:</p>
				<Highlight className="html rounded-md border-2">
