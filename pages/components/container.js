  ...
  return (
    <Container>
      <div className="flex flex-col gap-y-3">
        ...
        <p>
          As the pages have many similar style of title padding || margin, this
          component is made to generalize all the style those pages have.
        </p>
        <h3 className="text-xl font-bold">Container</h3>
        <p>This act as a container. Props:</p>
        <ul className="list-disc px-10">
          <code>
            <li className="pt-1">additional_class: class name string</li>
          </code>
        </ul>
        ...
        <Container.Title>Title</Container.Title>
        <p>
          Adding a <code>back</code> as seen below, the title now will have a
          back button on the right side of the title which can be used to go
        ...
        <p>This will add a subtitle into the container. Props:</p>
        <ul className="list-disc px-10">
          <code>
        ...
        <p>
          Adding a <code>tab</code> as seen below, will align the subtitle to
          the title if it contains a back button inside
        </p>
        <p className="font-bold">Code:</p>
        <Highlight className="html rounded-md border-2">
          {
