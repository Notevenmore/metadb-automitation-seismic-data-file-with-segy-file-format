      ...
      <div className="w-full flex flex-auto">
        <div className="flex flex-col flex-grow overflow-auto">
          <div className="flex flex-col space-y-2 py-5 px-10">
            ...
            <p>
              The <code>Table</code> component consists of the following props,
              with the bold ones being the{' '}
              <span className="font-bold">required</span> props:
            </p>
              ...
              <code>
                ...
                <li className="pt-1 font-bold">
                  ...
                  <p className="font-sans font-normal italic text-sm">
                    The <code className="bg-gray-200 px-1">content</code> prop
                    must be a two dimensional object (array of objects | array
                    of arrays) with the inner arrays | objects having the same
                    size as the header&apos;s array size.
                  </p>
                </li>
                <li className="pt-1 ">
                  with_checkbox: true|false
                  <p className="font-sans font-normal italic text-sm">
                    This prop will default to{' '}
                    <code className="bg-gray-200 px-1">false</code>, hence it is
                    not mandatory to be defined when calling this component
                  </p>
                </li>
            ...
            <p>
              Below are the example usages of the <code>table</code> component,
              with the <code>tableData</code> object defined below.
            </p>
            ...
            <div className="w-full space-y-2 pt-2">
              ...
              <p>
                An array of an array variable must be initialized to keep track
              ...
              <p>
                Directly using React&apos;s{' '}
                <code className="bg-gray-200 px-1">setState</code> hook is
                prevented for performance sake (to prevent unecessary
                re-renders, which is very resource expensive in this case),
                hence the use of dev console to see the previously initialized
                array being updated.
              </p>
              <p className="font-bold">Code:</p>
              <Highlight className="text-sm border-2 rounded-md">
              ...
              <div className="pt-2">
                <p>
                  Selected rows: (Change the selections in the table above, then
