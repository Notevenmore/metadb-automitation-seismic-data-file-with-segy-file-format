		...
		<Container>
			...
			<div className="space-y-5">
						...
						<FloatDialog items={
							{
								type: "",
								contents: [
									{ section_title: "Upload photo", section_content: "Maximum 1 MB", handleClick: () => uploadIMG() },
									{ section_title: "Remove photo", section_content: "", handleClick: () => handleRemovePhoto() },
								]
							}
						} className={`top-[35px] shadow-lg`} width="263px">
							<Buttons button_description="Edit" path="" additional_styles="py-0.5 pl-1.5 pr-3 space-x-0 border bg-transparent border-float_dialog text-[14px]" >
								<Image src="/icons/pencil.svg" width={10} height={10} className="w-[25px] h-[15px] alt='' " alt="icon" />
							</Buttons>
						</FloatDialog>
					</div>
					<TableComponent
				...
				<div className="flex space-x-2">
					...
					<Buttons path="" button_description="Sign out" onClick={handleSignOut} />
				</div>
			</div>
		</Container>
	);
