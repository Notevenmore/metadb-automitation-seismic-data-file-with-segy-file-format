			...
			{detail && (
				<form onSubmit={(e) => handleSubmit(e)} className="flex flex-col gap-y-2">
                    ...
                    <div className="flex items-center gap-x-3">
                        <button type="submit" className="px-3 py-1 rounded-[5px] hover:drop-shadow-lg bg-primary">Update</button>
                        <button className="bg-error text-white px-3 py-1 rounded-[5px] hover:drop-shadow-lg" onClick={handleRemove}>Delete</button>
                    </div>
				</form>
			)}
		</Container>
